...
//mysqli_connect function used to connect database to MySQL. Here Localhost is the Servername, root is the user name and placement_database is the name of the database.
